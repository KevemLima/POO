...
b_18 = Button(frame_corpo, command = lambda: calcular(), text = "=", width=5, height=2, bg=cor4, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
b_18.place(x=177, y=208)

#self.autenticar = Button(self.b_1)
